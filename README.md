...
Each assessment is developed on its own branch (for example `AI-5`, `AI-6`) and merged into `main` via pull request.
...
| `AI-7` | Stock Trading Agent and Agent Meets Analytics |